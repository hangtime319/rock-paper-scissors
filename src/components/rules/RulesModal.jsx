...
const RulesModal = ({ setIsRulesOpen, gameMode }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center md:bg-navy-900/70 md:z-30" onClick={() => setIsRulesOpen(false)}>
      <div className="w-full h-screen md:w-1/4 md:h-1/2 flex flex-col items-center justify-between bg-white z-40 py-12 md:py-8 md:px-4 md:rounded-md md:gap-4" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between md:w-full px-6">
          <h2 className="text-3xl font-bold text-navy-900">RULES</h2>
